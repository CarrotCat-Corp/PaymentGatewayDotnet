...
{
    public sealed class FinancialRequest: PaymentApiRequest, IPaymentApiRequest
    {
        /// <summary>
        ...
        public IEnumerable<KeyValuePair<string, string>> ToKeyValuePairs()
        {
            ...
            if (CashDiscount != null) list.Add(new KeyValuePair<string, string>("cash_discount", CashDiscount?.ToString("F2")));
            ...
            if (StoredCredentialsIndicatorParameters != null) list.AddRange(StoredCredentialsIndicatorParameters.ToKeyValuePairs());
            if (SignatureImage != null) list.Add(new KeyValuePair<string, string>("signature_image", SignatureImage));
            if (PinlessDebitOverride != null && PinlessDebitOverride == true) list.Add(new KeyValuePair<string, string>("pinless_debit_override", "Y"));
            if (DuplicateSeconds != null) list.Add(new KeyValuePair<string, string>("dup_seconds", DuplicateSeconds.ToString()));
            if (InstallmentBilling != null) list.AddRange(InstallmentBilling.ToKeyValuePairs());
            if (AuthorizationCode != null) list.Add(new KeyValuePair<string, string>("authorization_code", AuthorizationCode));
